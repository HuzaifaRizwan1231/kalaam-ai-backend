...
class VideoAnalyzer:
    """
    Combined analyzer for both Head Direction (Eye Contact) and Facial Expressions.
    Reduces compute by 50% by sharing the same MediaPipe FaceMesh inference and frame decoding.
    """
