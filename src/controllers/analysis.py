    ...
    async def create_analysis(
        ...
        try:
            ...
            if file_type == "video":
                ...
                gesture_task = asyncio.to_thread(
                    self.gesture_analyzer.analyze_gestures, video_path
                )
                gesture_analysis = await gesture_task
            else:
                gesture_analysis = None

            # Save gesture analysis results to the database
